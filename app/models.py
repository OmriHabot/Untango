...
class InferenceRequest(BaseModel):
    ...
    model: str = Field(default="gemini-3.0-flash", description="Model to use for inference")
...
class ChatRequest(BaseModel):
    ...
    model: str = Field(default="gemini-3.0-flash", description="Model to use")  # Field(default="gemini-3.0-flash", description="Model to use")
