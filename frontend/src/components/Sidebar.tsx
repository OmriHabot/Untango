      ...
      <div className="flex-1 overflow-y-auto p-2 space-y-1">
        {viewMode === 'showcase' ? (
          <>
            ...
            {[
              { id: 'docs', label: 'Setup Guide', icon: BookOpen },
              { id: 'agent', label: 'Agent vs RAG', icon: Terminal },
              { id: 'qualitative', label: 'Qualitative Comparison', icon: Layout },
              { id: 'hybrid', label: 'Hybrid Search', icon: GitBranch },
              { id: 'evaluation', label: 'Evaluation Metrics', icon: TableIcon },
              { id: 'chunking', label: 'AST Chunking', icon: Terminal },
            ].map((tab) => (
              <button
                key={tab.id}
